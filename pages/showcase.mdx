...
{<h1 className="mt-10 mb-4 text-center text-[2.5rem] font-bold tracking-tight">사례</h1>}

{<p className="mb-16 text-center text-lg text-gray-500 dark:text-gray-400">Nextra를 통해 문서화된 오픈 소스</p>}
